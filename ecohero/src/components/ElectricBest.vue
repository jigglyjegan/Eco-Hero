<template>
  <div v-if= "user">
      <h2> OVERALL ELECTRICAL CONSUMPTION</h2>
      <div class="card">
              <fa icon = "bolt-lightning" />
      </div>
    <column-chart :data="this.dataSet" xtitle="Department" ytitle="Electricity Consumption (kWh)"></column-chart>
...
export default {
  ...
  methods: {
    ...
    async graphData(user) {
        ...
        var uid = user.uid
        //console.log("PIE: " + uid)
        const collectionName = "elecUsageYrly";
